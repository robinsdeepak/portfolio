  ...
  experience: [
    {
      ...
      companylogo: require("./assets/images/headrun.svg"),
...
const podcastSection = {
  ...
  podcast: [
    "https://anchor.fm/codevcast/embed/episodes/DevStory---Deepak-Kumar-from-Karachi--Pakistan-e9givv/a-a15itvo"
  ],
  display: false // Set false to hide this section, defaults to true
};
